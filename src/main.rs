    ...
    loop {
        ...
        match game_state {
            GameState::Start => {
                ...
                draw_text("PONG", 330.0, 220.0, 70.0, WHITE);
                draw_text("Press SPACE to start", 250.0, 300.0, 30.0, GRAY);
            ...
            GameState::GameOver => {
                ...
                let winner = if left_score >= 10 {
                    "LEFT PLAYER"
                } else {
                    "RIGHT PLAYER"
                };

                draw_text(&format!("{} WINS!", winner), 220.0, 300.0, 50.0, GREEN);

                draw_text("Press R to restart", 260.0, 330.0, 30.0, GRAY);
